...
public class ApiExceptionHandlerTest {
    ...
    public void shouldMapBizExceptionToBusinessCode() {
        ResultVO result = handler.handleBizException(new ApiException(ExceptionEnums.ERROR_APIKEY));
    ...
    public void shouldMapBadJsonToParameterError() {
        ResultVO result = handler.handleHttpMessageNotReadableException(
    ...
    public void shouldMapIllegalArgumentToParameterError() {
        ResultVO result = handler.handleIllegalArgumentException(new IllegalArgumentException("state must not be null"));
    ...
    public void shouldMapUnknownExceptionToUnknownError() {
        ResultVO result = handler.handleUnknownException(new RuntimeException("boom"));
